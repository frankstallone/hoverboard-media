...
const Hero = ({ children, offset }) => (
  <>
    <Divider speed={0.2} offset={offset}>
      <UpDown>
        <SVG icon="hoverboard" width={48} fill={colors['green-light']} left="5%" top="2%" />
        <SVG icon="triangle" hiddenMobile width={48} stroke={colors.orange} left="60%" top="70%" />
        <SVG icon="box" width={6} fill={colors['grey-darker']} left="60%" top="15%" />
      </UpDown>
      <UpDownWide>
        <SVG icon="cloud" hiddenMobile width={24} fill={colors['blue-dark']} left="80%" top="20%" />
      ...
      <SVG icon="circle" width={64} fill={colors.red} left="95%" top="5%" />
